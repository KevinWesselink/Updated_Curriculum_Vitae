<x-layout>
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        <header class="text-center">
            ...
            <p class="mb-4">{{ __('edit_entry.soft_skill.edit_this_soft_skill') }}: {{ $softskill->skillName }}</p>
        </header>

        <form method="POST" action="{{ route('updateSoftSkill', $softskill->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-6">
                ...
                placeholder="{{ __('edit_entry.soft_skill.skill_name_placeholder') }}" value="{{ $softskill->skillName }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="experienceLevel"
                    placeholder="{{ __('edit_entry.soft_skill.experience_level_placeholder') }}" value="{{ $softskill->experienceLevel }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="smallExplanation1"
                    placeholder="{{ __('edit_entry.soft_skill.small_explanation_placeholder') }}" value="{{ $softskill->smallExplanation1 }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="smallExplanation2"
                    placeholder="{{ __('edit_entry.soft_skill.small_explanation_placeholder') }}" value="{{ $softskill->smallExplanation2 }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="smallExplanation3"
                    placeholder="{{ __('edit_entry.soft_skill.small_explanation_placeholder') }}" value="{{ $softskill->smallExplanation3 }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="smallExplanation4"
                    placeholder="{{ __('edit_entry.soft_skill.small_explanation_placeholder') }}" value="{{ $softskill->smallExplanation4 }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="smallExplanation5"
                    placeholder="{{ __('edit_entry.soft_skill.small_explanation_placeholder') }}" value="{{ $softskill->smallExplanation5 }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="startedWith"
                    placeholder="{{ __('edit_entry.soft_skill.started_with_placeholder') }}" value="{{ $softskill->startedWith }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="workedWithUntil"
                    placeholder="{{ __('edit_entry.soft_skill.worked_with_until_placeholder') }}" value="{{ $softskill->workedWithUntil }}" />
