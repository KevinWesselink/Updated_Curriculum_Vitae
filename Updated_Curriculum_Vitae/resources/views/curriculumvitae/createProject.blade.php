    ...
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        <header class="text-center">
            <h2 class="text-2xl font-bold uppercase mb-1">
                {{ __('add_entry.project.create_project') }}
            </h2>
            <p class="mb-4">{{ __('add_entry.project.add_project') }}</p>
        </header>
        ...
        <form method="POST" action="{{ route('storeProject') }}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                placeholder="{{ __('add_entry.project.project_name_placeholder') }}" value="{{ old('projectName') }}" />
            ...
            <div class="mb-6">
                ...
                placeholder="{{ __('add_entry.project.project_description_placeholder') }}" value="{{ old('projectDescription') }}"></textarea>
            ...
            <div class="mb-6">
                ...
                placeholder="{{ __('add_entry.project.project_link_placeholder') }}" value="{{ old('projectLink') }}" />
            ...
            <div class="mb-6">
                ...
                placeholder="{{ __('add_entry.project.project_role_placeholder') }}" value="{{ old('projectRole') }}" />
            ...
            <div class="mb-6">
                ...
                placeholder="{{ __('add_entry.project.project_technologies_placeholder') }}" value="{{ old('projectTechnologies') }}" />
            ...
            <div class="mb-6">
                ...
                min="0" placeholder="{{ __('add_entry.project.project_teamsize_placeholder') }}" value="{{ old('projectTeamSize') }}" />
            ...
            <div class="mb-6">
                ...
                placeholder="{{ __('add_entry.project.project_client_placeholder') }}" value="{{ old('projectClient') }}" />
            ...
            <div class="mb-6">
                ...
                placeholder="{{ __('add_entry.project.project_location_placeholder') }}" value="{{ old('projectLocation') }}" />
