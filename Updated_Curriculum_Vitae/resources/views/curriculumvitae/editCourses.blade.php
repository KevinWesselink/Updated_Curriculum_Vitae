        ...
        <form method="POST" action="/courses/{{ $courses->id }}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="courseName"
                    placeholder="{{ __('edit_entry.course.course_name_placeholder') }}" value="{{ $courses->courseName }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="smallExplanation1"
                    placeholder="{{ __('edit_entry.course.small_explanation_placeholder') }}" value="{{ $courses->smallExplanation1 }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="smallExplanation2"
                    placeholder="{{ __('edit_entry.course.small_explanation_placeholder') }}" value="{{ $courses->smallExplanation2 }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="smallExplanation3"
                    placeholder="{{ __('edit_entry.course.small_explanation_placeholder') }}" value="{{ $courses->smallExplanation3 }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="smallExplanation4"
                    placeholder="{{ __('edit_entry.course.small_explanation_placeholder') }}" value="{{ $courses->smallExplanation4 }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="smallExplanation5"
                    placeholder="{{ __('edit_entry.course.small_explanation_placeholder') }}" value="{{ $courses->smallExplanation5 }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="validityEarned"
                    placeholder="{{ __('edit_entry.course.validity_earned_placeholder') }}" value="{{ $courses->validityEarned }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="validUntil"
                    placeholder="{{ __('edit_entry.course.valid_until_placeholder') }}" value="{{ $courses->validUntil }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="certificationLocation"
                    placeholder="{{ __('edit_entry.course.certification_location_placeholder') }}" value="{{ $courses->certificationLocation }}" />
